...
class Tournament:
    def __init__(self,name,place,start_date,end_date, description, player_number, rounds=[], players: list =[], status="In progress", current_round=0, round_number=4):
        self.name = name
        self.place = place
